               ...
               <div className=" container w-100 ">
                    <div className=" row  mb-100">
                         <div className=" bg-white shadow-lg col-lg-8 rounded-3 px-0">
                             ...
                             {setDriverDetails.map(detail => (
                               <div key={detail.id} className=" row mt-20 p-5" >
                               <div className=" col-lg-3"><img src={`/images/team/${detail.photo}`} width="100%" className=" rounded-4" /></div>
                               <div className=" col-lg-9">
                                    <div className=" row " style={{ height: "100%" }}>
                                         <div className=" col-lg-6">
                                              <div className=" d-flex flex-column justify-content-between" style={{ height: "100%" }}>
                                                   <div>
                                                        <div className=" fs-4 fw-medium">{detail.fullName}</div>
                                                        <div style={{ letterSpacing: "2px" }}>{detail.carModel}  <i className="fa fa-car"></i></div>
                                                        <div style={{ letterSpacing: "1px" }}>{detail.plateNo}</div>
                                                   </div>


                                                   <div style={{ fontSize: "15px" }}><span>from {company},</span><span className=" ms-2">{detail.gender}</span></div>
                                              </div>
                                         </div>
                                         <div className=" col-lg-6">
                                              <div className=" d-flex flex-column justify-content-between align-items-end" style={{ height: "100%" }}>
                                                   <div>
                                                        <div className=" pt-5" style={{ fontSize: "14px" }}> <i className="fa fa-phone me-1"></i><a href="tel:+9034564322">{detail.phone}</a></div>
                                                   </div>
                         ...
                         <div className=" bg-white shadow-lg col-lg-3 ms-5 col-sm-12 mt-lg-4 " style={{ maxHeight: "500px" }}>
                              <div className=" p-2 ">
                                   ...
                                   <div className=" d-flex fs-4">
                                        ...
                                        <div className=" col-lg-5 col-sm-2 d-flex"> <img src="/images/icon/naira-icon.png" width="30px" height="30px" className="" /> <span>{fare}</span></div>
                                   </div>
                              </div>
                         </div>
                    </div>
